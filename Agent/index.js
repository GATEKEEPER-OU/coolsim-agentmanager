...
export default class Agent {
  ...
  async dailyRoutine(events = []) {
    ...
    return new Promise((resolve, reject) => {
      ...
      let day = {
        ...
        simulation: this.simulation,
        stats: this.stats,
        conditions: this.conditions.reduce((partial, condition)=>{
          let description = {
            severity: condition.severityLevel,
            status: condition.duration,
            type: condition.type
          }
          partial[condition.label] = description;
          return partial;
        },{}),
        events: {
        ...
        activities: {
          ...
          activities: Utils.mapToObject(actionsOutcomes.duration),
  ...
  _decideActions(dailies) {
    return dailies.reduce((partial, action) => {
      ...
      return partial;
    }, { diary: [], actions: [], skips: [], allocated: 0 });
  }
